...
The full paper can be accessed [here](https://arxiv.org/abs/2410.03755). 

## Code

The code implementation of the methods described in the paper can be found [here](https://github.com/D-JEPA/djepa-imagenet).
